...
<body>
    ...
    <div class="main">
        ...
        <table style="width:95%">
            ...
            <tr>
                <td headers="nev2">Betyár betyu (füstölt tarjával, sajttal, pepperónival töltve-rántva), vegyes körettel
                </td>
                <td headers="ar4" class="arak">2400.-</td>
            </tr>

            <tr>
                <td headers="nev2">Konfitált tarjaa grillkolbásszal, dijoni mustáros steakburgonyával és tormamártással
                </td>
                <td headers="ar4" class="arak">3100.-</td>
            </tr>

            <tr>
                <td headers="nev2">Grillezett sertéskaraj libamájjal, vargányás erdei gombapaprikással és túrós
                    csuszával</td>
        ...
        <table style="width:95%">
            ...
            <tr>
                <td headers="nev3">Bőrös csirkemell steak tejszínes gombamártással, jázmin rizzsel és csónak burgonyával
                </td>
                <td headers="ar5" class="arak">2790.-</td>
            </tr>

            <tr>
                <td headers="nev3">Mandulás köntösben kisütött, aszalt szilvás-camembertes csirkemell tekercs krokettel
                    és forró gyümölcs-mártogatóssal</td>
                <td headers="ar5" class="arak">2790.-</td>
            </tr>
        ...
        <table style="width:95%">
            ...
            <tr>
                <td headers="nev4">Bélszín steak sistergő lávakövön sütve mustáros borskéregben, steakburgonyával, grill
                    zöldségekkel</td>
        ...
        <table style="width:95%">
            ...
            <tr>
                <td headers="nev7">Camembert sajt mandula bundában, ropogós köntösben, kékáfonya mártással, jázmin
                    rizzsel</td>
        ...
        <table style="width:95%">
            ...
            <tr>
                <td headers="nev10">Édes álom (gyümölcssaláta ágyon somlói galuska, eper fagylalt, tejszínhab, csokoládé
                    öntet)</td>
                <td headers="ar12" class="arak">1090.-</td>
            </tr>
            <tr>
                <td headers="nev10">Kiskakas töltött palaincsta (édes morzsában rántott túrós palacsinta, meggyraguval)
                </td>
                <td headers="ar12" class="arak">990.-</td>
            </tr>
            <tr>
